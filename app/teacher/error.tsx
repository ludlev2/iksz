...
export default function TeacherAreaError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-10">
      <ErrorState
        title="Nem sikerült betölteni a tanári felületet"
        description="Próbáld frissíteni az oldalt, vagy lépj vissza a bejelentkezéshez."
        onRetry={reset}
      >
